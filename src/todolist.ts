...
function appendTodo(): void {
  ...
  todosArray.forEach((item: Todo) => {
    taskComponent += `
      <div
        class="bg-subInput border ${
          !item.status ? "border-red-400" : "border-green-400"
        } rounded-default min-w-[74rem] px-[7rem] py-[3rem] my-9 transition-all"
      >
        ...
        <div class="flex items-center gap-10">
          <div class="flex items-center gap-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
